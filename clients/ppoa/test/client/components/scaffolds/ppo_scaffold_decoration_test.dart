...
// Project imports:
import 'package:ppoa/client/components/templates/scaffolds/ppo_scaffold_decoration_test_page.dart';
...
Future<void> _renderPage(String testCaseName, WidgetTester tester) async {
  const PPOScaffoldDecorationTestPage widget = PPOScaffoldDecorationTestPage();
