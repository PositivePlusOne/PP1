...
import '../components/atoms/stamps/design_system_stamps_view.dart';
...
@MaterialAutoRouter(
  ...
  routes: <AutoRoute>[
    ...
    AutoRoute(page: DesignSystemStampView, path: '/design-system/stamps', meta: $AppRouter.kSimulatorGroupDesignSystem),
  ],
)
class $AppRouter {
