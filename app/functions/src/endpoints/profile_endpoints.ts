...
export namespace ProfileEndpoints {
  export const getProfiles = functions
    .region("europe-west3")
    ...
    .https.onCall(async (request: EndpointRequest, context) => {
      ...
      if (uncachedProfileIds.length > 0) {
        let uncachedProfiles =
          (await DataService.getBatchDocuments({
  ...
  export const getProfileByDisplayName = functions
    .region("europe-west3")
    .runWith(FIREBASE_FUNCTION_INSTANCE_DATA)
    .https.onCall(async (request: EndpointRequest, context) => {
      await SystemService.validateUsingRedisUserThrottle(context);
  ...
  export const toggleProfileDeletion = functions
    .region("europe-west3")
    .runWith(FIREBASE_FUNCTION_INSTANCE_DATA)
    .https.onCall(async (request: EndpointRequest, context) => {
      await SystemService.validateUsingRedisUserThrottle(context);
  ...
  export const updateCompanySectors = functions
    .region("europe-west3")
    .runWith(FIREBASE_FUNCTION_INSTANCE_DATA)
    .https.onCall(async (request: EndpointRequest, context) => {
      await SystemService.validateUsingRedisUserThrottle(context);
  ...
  export const updatePlace = functions
    .region("europe-west3")
    .runWith(FIREBASE_FUNCTION_INSTANCE_DATA)
    .https.onCall(async (request: EndpointRequest, context) => {
      await SystemService.validateUsingRedisUserThrottle(context);
  ...
  export const updateAccentColor = functions
    ...
    .https.onCall(async (request: EndpointRequest, context) => {
      ...
      if (!isProfileComplete && !profile.suppressEmailNotifications) {
        ...
        wasWelcomeEmailSent = await EmailHelpers.sendEmail(profile.email, "Positive+1 Account Setup", "You Are All Set", "Your account has been fully set up. Welcome to the community!", "", "Return to Positive+1", "https://www.positiveplusone.com");
      }
  ...
  export const addMedia = functions
    .region("europe-west3")
    .runWith(FIREBASE_FUNCTION_INSTANCE_DATA)
    .https.onCall(async (request: EndpointRequest, context) => {
      await SystemService.validateUsingRedisUserThrottle(context);
  ...
  export const removeMedia = functions
    .region("europe-west3")
    .runWith(FIREBASE_FUNCTION_INSTANCE_DATA)
    .https.onCall(async (request: EndpointRequest, context) => {
      await SystemService.validateUsingRedisUserThrottle(context);
