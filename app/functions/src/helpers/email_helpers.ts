...
export namespace EmailHelpers {
   ...
   */
  export async function sendEmail(to: string, subjectLine: string, title: string, body: string, bodyPostscript: string, buttonText: string, buttonActionUrl: string): Promise<boolean> {
