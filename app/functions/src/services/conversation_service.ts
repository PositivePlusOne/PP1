...
import {SendEventMessage, SystemEventType} from "../dto/conversation_dtos";
...
export namespace ConversationService {
   ...
   */
  export async function sendEventMessage(data: SendEventMessage, client: StreamChat<DefaultGenerics>) {
