...
class AppRouter extends _$AppRouter {
  ...
  List<AutoRoute> get routes => [
        ...
        CupertinoRoute(page: OnboardingOurPledgeRoute.page, path: '/onboarding/our-pledge'),
        CupertinoRoute(page: OnboardingYourPledgeRoute.page, path: '/onboarding/your-pledge'),
        //* Registration and Onboarding
        CupertinoRoute(page: RegistrationAccountRoute.page, path: '/registration/account'),
        CupertinoRoute(page: RegistrationEmailEntryRoute.page, path: '/registration/create/email'),
        CupertinoRoute(page: RegistrationPasswordEntryRoute.page, path: '/registration/create/password'),
        CupertinoRoute(page: RegistrationPhoneEntryRoute.page, path: '/registration/create/phone'),
        CupertinoRoute(page: RegistrationAccountSetupRoute.page, path: '/registration/profile/start'),
        CupertinoRoute(page: RegistrationCompleteRoute.page, path: '/registration/profile/complete'),
        //* Login and Authentication
        CupertinoRoute(page: LoginRoute.page, path: '/login', guards: [signedOutGuard]),
        CupertinoRoute(page: LoginPasswordRoute.page, path: '/login/password', guards: [signedOutGuard]),
        CupertinoRoute(page: LoginWelcomeBackRoute.page, path: '/login/success'),
        CupertinoRoute(page: LoginAccountRecoveryRoute.page, path: '/login/recovery'),
        CupertinoRoute(page: ForgottenPasswordRoute.page, path: '/login/password-forgotten', guards: [signedOutGuard]),
        CupertinoRoute(page: ForgottenPasswordRecoveryRoute.page, path: '/login/password-forgotten-recovery', guards: [signedOutGuard]),
        //* User Preferences Configuration
        CupertinoRoute(page: NotificationPreferencesRoute.page, path: '/notifications'),
        CupertinoRoute(page: BiometricsPreferencesRoute.page, path: '/biometrics'),
        //* Organisation Setup
        CupertinoRoute(page: OrganisationNameSetupRoute.page, path: '/organisation/setup/name', guards: [signedInGuard]),
        CupertinoRoute(page: OrganisationCompanySectorSelectRoute.page, path: '/organisation/setup/sectors', guards: [signedInGuard]),
        //* Profile Setup
        CupertinoRoute(page: ProfileWelcomeBackRoute.page, path: '/profile/setup/continue', guards: [signedInGuard]),
        CupertinoRoute(page: ProfileNameEntryRoute.page, path: '/profile/setup/name', guards: [signedInGuard]),
        CupertinoRoute(page: ProfileHivStatusRoute.page, path: '/registration/profile/hiv-status', guards: [signedInGuard]),
        CupertinoRoute(page: ProfileDisplayNameEntryRoute.page, path: '/profile/setup/display-name', guards: [signedInGuard]),
        CupertinoRoute(page: ProfileBirthdayEntryRoute.page, path: '/profile/setup/birthday', guards: [signedInGuard]),
        CupertinoRoute(page: ProfileBirthdayDeleteAccountRoute.page, path: '/profile/setup/delete', guards: [signedInGuard]),
        CupertinoRoute(page: ProfileGenderSelectRoute.page, path: '/profile/setup/gender', guards: [signedInGuard]),
        CupertinoRoute(page: ProfileInterestsEntryRoute.page, path: '/profile/setup/interests', guards: [signedInGuard]),
        CupertinoRoute(page: ProfileLocationRoute.page, path: '/profile/setup/map-location', guards: [signedInGuard]),
        CupertinoRoute(page: ProfileReferenceImageWelcomeRoute.page, path: '/profile/setup/references/start', guards: [signedInGuard]),
        CupertinoRoute(page: ProfileReferenceImageCameraRoute.page, path: '/profile/setup/references/camera', guards: [signedInGuard]),
        CupertinoRoute(page: ProfileReferenceImageSuccessRoute.page, path: '/profile/setup/images/references/success', guards: [signedInGuard]),
        CupertinoRoute(page: ProfileAccentPhotoRoute.page, path: '/profile/setup/accent', guards: [signedInGuard]),
        CupertinoRoute(page: ProfilePhotoSelectionRoute.page, path: '/profile/setup/images/profile', guards: [signedInGuard]),
        CupertinoRoute(page: ProfileBiographyEntryRoute.page, path: '/profile/setup/biography', guards: [signedInGuard]),
        CupertinoRoute(page: ProfileEditThanksRoute.page, path: '/profile/setup/thanks', guards: kCommonGuards),
        //* Profile
        CupertinoRoute(page: ProfileRoute.page, path: '/profile/view', guards: [profileDisplayGuard]),
        CupertinoRoute(page: ProfileDetailsRoute.page, path: '/profile/details/view', guards: [profileDisplayGuard]),
        CupertinoRoute(page: ProfileAboutRoute.page, path: '/profile/about', guards: [signedInGuard]),
        //* Home and direct affiliates
        CupertinoRoute(page: HomeRoute.page, path: '/home', guards: [pledgeGuard, authSetupGuard, profileSetupGuard, organisationSetupGuard, notificationGuard, biometricsGuard, securityGuard]),
        CupertinoRoute(page: HomeLoginPromptRoute.page, path: '/home/login', guards: [...kCommonGuards]),
        CupertinoRoute(page: SearchRoute.page, path: '/search', guards: kCommonGuards),
        CupertinoRoute(page: ChatConversationsRoute.page, path: '/chat/conversations', guards: kCommonGuards),
        CupertinoRoute(page: CreateConversationRoute.page, path: '/chat/connections_list', guards: [...kCommonGuards, signedInGuard]),
        CupertinoRoute(page: ChatMembersRoute.page, path: '/chat/members', guards: kCommonGuards),
        CupertinoRoute(page: ChatRoute.page, path: '/chat/current', guards: kCommonGuards),
        //* Account
        CupertinoRoute(page: AccountRoute.page, path: '/account', guards: kCommonGuards),
        CupertinoRoute(page: AccountDetailsRoute.page, path: '/account/details', guards: kCommonGuards),
        CupertinoRoute(page: AccountCommunitiesRoute.page, path: '/account/communities', guards: kCommonGuards),
        CupertinoRoute(page: AccountUpdateNameRoute.page, path: '/account/update/name', guards: kCommonGuards),
        CupertinoRoute(page: AccountUpdateEmailAddressRoute.page, path: '/account/update/email', guards: kCommonGuards),
        CupertinoRoute(page: AccountUpdatePhoneNumberRoute.page, path: '/account/update/phone', guards: kCommonGuards),
        CupertinoRoute(page: AccountUpdatePasswordRoute.page, path: '/account/update/password', guards: kCommonGuards),
        CupertinoRoute(page: AccountConfirmPasswordRoute.page, path: '/account/confirm/password', guards: kCommonGuards),
        CupertinoRoute(page: AccountConnectEmailRoute.page, path: '/account/connect/email', guards: kCommonGuards),
        CupertinoRoute(page: AccountSocialDisconnectionRoute.page, path: '/account/connect/email/social', guards: kCommonGuards),
        CupertinoRoute(page: AccountDeleteProfileRoute.page, path: '/account/delete', guards: kCommonGuards),
        CupertinoRoute(page: AccountUpdatedRoute.page, path: '/account/update/complete', guards: kCommonGuards),
        CupertinoRoute(page: AccountProfileEditSettingsRoute.page, path: '/account/profile', guards: kCommonGuards),
        CupertinoRoute(page: AccountPreferencesRoute.page, path: '/account/preferences', guards: kCommonGuards),
        CupertinoRoute(page: AccountConnectSocialRoute.page, path: '/account/connect/social', guards: kCommonGuards),
        CupertinoRoute(page: AccountPromotedPostsRoute.page, path: '/account/posts/promoted_posts', guards: kCommonGuards),
        CupertinoRoute(page: AccountPromotedPostsPromotionRoute.page, path: '/account/posts/promoted_promotion', guards: kCommonGuards),
        //* Notifications
        CupertinoRoute(page: NotificationsRoute.page, path: '/notifications', guards: kCommonGuards),
        //* Guidance
        CupertinoRoute(page: GuidanceRoute.page, path: '/guidance', guards: kCommonGuards),
        CupertinoRoute(page: GuidanceDirectoryRoute.page, path: '/guidance/directory', guards: kCommonGuards),
        CupertinoRoute(page: GuidanceDirectoryEntryRoute.page, path: '/guidance/directory/:id', guards: kCommonGuards),
        CupertinoRoute(page: GuidanceEntryRoute.page, path: '/guidance/:id', guards: kCommonGuards),
        //* Content
        CupertinoRoute(page: MediaRoute.page, path: '/media', guards: kCommonGuards),
        CupertinoRoute(page: PostRoute.page, path: '/post'),
        CupertinoRoute(page: TagFeedRoute.page, path: '/tag/:tag', guards: kCommonGuards),
        CupertinoRoute(page: CreatePostRoute.page, path: '/post/create', guards: [...kCommonGuards, signedInGuard]),
        CupertinoRoute(page: PostShareRoute.page, path: '/post/share'),
        //* Dialogs
        CupertinoRoute(page: TermsAndConditionsRoute.page, path: '/terms'),
        CupertinoRoute(page: HintDialogRoute.page, path: '/help/dialog'),
        CupertinoRoute(page: VerificationDialogRoute.page, path: '/verification/dialog'),
        //* Other
        CupertinoRoute(page: ErrorRoute.page, path: '/error'),
        CupertinoRoute(page: DevelopmentRoute.page, path: '/devtools'),
