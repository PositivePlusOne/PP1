...
import '../widgets/organisms/profile/profile_interest_page.dart';
...
@CustomAutoRouter(
  ...
  routes: [
    ...
    AutoRoute(page: ProfileInterestsPage, path: '/profile/setup/interests', guards: [AuthenticationGuard, ProfileExistsGuard]),
