...
abstract class $NewAccountFormStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({String emailAddress, String phoneNumber, String pin});
}
...
class _$_NewAccountFormState implements _NewAccountFormState {
  const _$_NewAccountFormState(
      {this.emailAddress = '', this.phoneNumber = '', this.pin = ''});
  ...
  @override
  String toString() {
    return 'NewAccountFormState(emailAddress: $emailAddress, phoneNumber: $phoneNumber, pin: $pin)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, emailAddress, phoneNumber, pin);
...
abstract class _NewAccountFormState implements NewAccountFormState {
  const factory _NewAccountFormState(
      {final String emailAddress,
      final String phoneNumber,
      final String pin}) = _$_NewAccountFormState;
