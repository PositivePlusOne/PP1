...
class DesignTypographyModel with _$DesignTypographyModel {
  factory DesignTypographyModel({
    ...
    @JsonKey(fromJson: textStyleFromJson, toJson: textStyleToJson) required TextStyle styleHeroExtraSmall,
    ...
    @JsonKey(fromJson: textStyleFromJson, toJson: textStyleToJson) required TextStyle styleSubtitleBold,
    ...
    @JsonKey(fromJson: textStyleFromJson, toJson: textStyleToJson) required TextStyle styleNotification,
  ...
  factory DesignTypographyModel.empty() => DesignTypographyModel(
        ...
        styleHeroExtraSmall: const TextStyle(
          fontFamily: 'BN',
          fontWeight: FontWeight.w400,
          fontSize: 14.0,
        ),
        ...
        styleSubtitleBold: const TextStyle(
          fontFamily: 'AlbertSans',
        ...
        styleNotification: const TextStyle(
          fontFamily: 'AlbertSans',
          fontWeight: FontWeight.w400,
          fontSize: 14.0,
        ),
