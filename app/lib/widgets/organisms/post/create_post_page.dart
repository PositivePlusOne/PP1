...
class _CreatePostPageState extends ConsumerState<CreatePostPage> {
  ...
  Future<void> onFirstRender(Duration timeStamp) async {
    ...
    if (widget.activityData != null) {
      ...
      ref.read(createPostViewModelProvider.notifier).onFirstOpen();
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    //? Replace with PopScope, however PopScope causes crashes within our navigation system due to disposal of scope during pop?
    return WillPopScope(
