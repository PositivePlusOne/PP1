...
class ReactionReportDialog extends ConsumerWidget {
  const ReactionReportDialog({
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Column(
      children: <Widget>[
        Text(
          localizations.comment_report_dialog_body,
