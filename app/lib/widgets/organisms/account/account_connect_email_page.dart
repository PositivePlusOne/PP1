...
@RoutePage()
class AccountConnectEmailPage extends ConsumerWidget {
  const AccountConnectEmailPage({super.key});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return PositiveGenericPage(
      ...
      body: 'To connect an email address we require a password. Please enter one below!',
      canBack: true,
      currentStepIndex: 0,
      totalSteps: 3,
