...
part of 'onboarding_our_pledge_view_model.dart';
...
/// @nodoc
mixin _$OnboardingOurPledgeViewModelState {
  bool get hasAcceptedPledge => throw _privateConstructorUsedError;

  @JsonKey(ignore: true)
  $OnboardingOurPledgeViewModelStateCopyWith<OnboardingOurPledgeViewModelState>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $OnboardingOurPledgeViewModelStateCopyWith<$Res> {
  factory $OnboardingOurPledgeViewModelStateCopyWith(
          OnboardingOurPledgeViewModelState value,
          $Res Function(OnboardingOurPledgeViewModelState) then) =
      _$OnboardingOurPledgeViewModelStateCopyWithImpl<$Res,
          OnboardingOurPledgeViewModelState>;
  @useResult
  $Res call({bool hasAcceptedPledge});
}

/// @nodoc
class _$OnboardingOurPledgeViewModelStateCopyWithImpl<$Res,
        $Val extends OnboardingOurPledgeViewModelState>
    implements $OnboardingOurPledgeViewModelStateCopyWith<$Res> {
  _$OnboardingOurPledgeViewModelStateCopyWithImpl(this._value, this._then);
...
class _$OnboardingOurPledgeViewModelStateImpl
  ...
  @override
  String toString() {
    return 'OnboardingOurPledgeViewModelState(hasAcceptedPledge: $hasAcceptedPledge)';
  }
