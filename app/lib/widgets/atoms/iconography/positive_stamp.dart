...
class PositiveStamp extends StatefulWidget {
  const PositiveStamp({
  ...
  factory PositiveStamp.onePlus({
    ...
    return PositiveStamp(
      ...
      circleColour: color ?? colors.black,
      radialPadding: size / 90,
      animate: animate,
    );
  }

  factory PositiveStamp.fist({
    required DesignColorsModel colors,
    double size = 200,
    double animationStartValue = 0.0,
    Alignment? alignment,
  ...
  factory PositiveStamp.smile({
    ...
    return PositiveStamp(
      ...
      fillColour: fillColour ?? colors.teal,
      animate: false,
    );
  }

  @override
  State<PositiveStamp> createState() => _StampState();
}

class _StampState extends State<PositiveStamp> with SingleTickerProviderStateMixin {
